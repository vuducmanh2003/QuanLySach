	...
	<div class="container">
						...
						<div class="product well">
							...
							<div class="col-md-9">
								<div class="caption">
									...
									if ($s["KhuyenMai"] == true) {
									?>
										<div class="price"><?php echo $s["giakhuyenmai"] ?> VNĐ</div>
									<?php
									}
									?>
									<?php
									...
									?>
										<div class="price"><?php echo $s["Gia"] ?> VNĐ</div>
									<?php
									}
									?>
									...
									?>
										<label style="color:red">Thành tiền: <?php
																				echo  $_SESSION['cart'][$s["ID"]] * $s["giakhuyenmai"] ?>.000 VNĐ </label>
									<?php
									}
									?>
									<?php
									...
									?>
										<label style="color:red">Thành tiền: <?php
																				echo  $_SESSION['cart'][$s["ID"]] * $s["Gia"] ?>.000 VNĐ </label>
									<?php
									}
									?>
		...
		<div class="row">
			<div class="col-md-4 col-md-offset-8 ">
				...
				<center>
					<p style="color:red; font-size: 24px"><i class="fa fa-exclamation" aria-hidden="true"> Bạn cần đăng nhập để đặt hàng</i></p>
					<!-- <a href="index.php" class="btn btn-primary" style="margin-left:-76px">Chọn những sách khác</a></center> -->
			</div>
			<div class="row">
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8">
						...
						<center>
							<a href="account.php" class="btn btn-warning" style="font-weight:bold; font-size: 20px">Vào trang đăng nhập</a>
						</center>
